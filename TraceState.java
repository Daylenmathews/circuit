...
/**
 * Represents a potential path through a CircuitBoard - a search state for
 * CircuitTracer.
 *
 * @author mvail
 */
public class TraceState {
    ...
    /**
     * New state adding given row and column position to the path from previous
     * state
     *
     * @param previousState
    ...
    /**
     * @return the current CircuitBoard from this state with the path filled in
     * with 'T's
     */
